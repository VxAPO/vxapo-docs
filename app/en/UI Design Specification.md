...
- Animation table: view switch 0.32 s + 800 ms collapse, tab 0.15 s, card hover 0.18 s, dialog 0.18 s, toast 0.2 s, drag 320–430 ms, curve tip 8%/frame + 280 ms flip, curve recompute 42 ms throttle, scrollbar 0.25 s fade + 1.2 s idle, theme transition 0.35 s.
